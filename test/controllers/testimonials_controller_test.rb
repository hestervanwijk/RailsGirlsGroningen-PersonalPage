...
class TestimonialsControllerTest < ActionController::TestCase
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post :create, testimonial: { bedrijf: @testimonial.bedrijf, functie: @testimonial.functie, naam: @testimonial.naam, statement: @testimonial.statement }
    end
  ...
  test "should update testimonial" do
    patch :update, id: @testimonial, testimonial: { bedrijf: @testimonial.bedrijf, functie: @testimonial.functie, naam: @testimonial.naam, statement: @testimonial.statement }
    assert_redirected_to testimonial_path(assigns(:testimonial))
  end
